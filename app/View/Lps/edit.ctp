...
<?php echo $this->Form->create('Lp'); ?>
	<fieldset>
		<legend><?php echo __('Edit Lp'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Lp.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Lp.id'))); ?></li>
